...
class DataFactoryCases(FunBaseModel):
    ...
    def __init__(self, project_id, title, name, description, group_name, header, owner, path, param_in, param_out,
                 example_param_in, example_param_out, user, del_flag=0, id=None):
